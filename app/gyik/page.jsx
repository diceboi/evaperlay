...
export default function Gyik() {
  ...
  return (
    <>
      <Mainheader title={'GYIK'} subtitle={'Gyakran ismételt kérdések'} image={'/gyik.webp'} bgposition={'lg:bg-[left_0rem_top_-15rem] bg-[left_-10rem_top_-10rem] lg:bg-[length:100%] bg-[length:250%]'}/>
