...
export default function Mainheader({ title, subtitle, image }) {
  return (
    <>
      <section className="relative flex flex-col items-center justify-end text-white w-full lg:min-h-[60vh] min-h-[50vh] overflow-hidden shadow-2xl px-2">
