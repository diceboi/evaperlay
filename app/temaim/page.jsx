      ...
      <Regularcontainer padding={"lg:py-32 py-16"} bgcolor={"bg-[--white]"}>
        <div className="flex flex-col">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-16">
            <div className="flex flex-col items-center gap-8 lg:py-16 py-8 bg-white shadow-lg lg:p-8 p-4">
              <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-auto flex-wrap gap-4 list-disc marker:text-[--aquamarine] w-full">
                <li className="p-2 ml-6 bg-white max-w-[-150px] shadow-sm">
            ...
            <div className="flex flex-col items-center gap-8 lg:py-16 py-8 bg-white shadow-lg lg:p-8 p-4">
              <div className="flex flex-col gap-4">
                <H3 className="text-center">Munkahelyi egyenlőség</H3>
              </div>
              <ul className="flex flex-auto flex-wrap  gap-4 list-disc marker:text-[--aquamarine] w-full">
                <li className="p-2 ml-6 bg-white max-w-[-150px] shadow-sm">
                  <Paragraph>
            ...
            <div className="flex flex-col items-center gap-8 lg:py-16 py-8 bg-white shadow-lg lg:p-8 p-4">
              <div className="flex flex-col gap-4">
                <H3 className="text-center">Sokszínűség és befogadás</H3>
              </div>
              <ul className="flex flex-auto flex-wrap  gap-4 list-disc marker:text-[--aquamarine] w-full">
                <li className="p-2 ml-6 bg-white max-w-[-150px] shadow-sm">
                  <Paragraph>
