      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="w-full">
          ...
          >
            ...
            <SwiperSlide>
              <Coachingreferencetile image={'/referenciak/hevesi-nora.webp'} name={'Hevesi Nóra'} from={'Kommunikációs vezető, Tesco-Global Áruházak Zrt.'} comment={'<p>Éva a Tesco és az Egyenlítő Alapítvány együttműködésének egyik motorja. Nemcsak a közös munka stratégiai keretének kialakításában támogatott bennünket maximálisan, de kiemelt figyelmet fordított a vállalati célok megvalósulására, arra, hogy igazi non-profit és for-profit win-win helyzetbe hozzuk egymást.<br><br>Éva hozzáállása, gyorsasága, precizitása, segítőkészsége, kreativitása és nyitottsága jelentősen hozzájárult közös sikereinkhez.</p>'}/>
            </SwiperSlide>
            <SwiperSlide>
