      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="w-full">
          ...
          >
            ...
            <SwiperSlide>
              <Coachingreferencetile image={'/referenciak/kemeri-greguss-nora.jpeg'} name={'Kémeri-Greguss Nóra'} from={'webdesigner, szabadúszó'} comment={'Évit régről ismerem, tudtam róla, hogy a munkájára igényes, illetve hogy egy nagyon empatikus személyiség, de coach-ként a LinkedIn-en figyeltem fel a tartalmaira és tevékenységére. A közös munka során azt kaptam, amit vártam, sokszor volt "aha" élményem és pont ez kellett, hogy én magam ismerjek fel dolgokat, mert ez sokkal erősebb, mintha valaki kívülről mondja meg.<br><br>Évinek nagy szerepe volt abban a fejlődésben, amin végigmentem a 4 hónap alatt, míg együtt dolgoztunk, nagyon szívesen ajánlom őt, ha valakinek támogató, elfogadó és előrevivő segítségre van szüksége egy probléma megoldásában.'}/>
            </SwiperSlide>
            <SwiperSlide>
            ...
            <SwiperSlide>
              <Coachingreferencetile image={'/referenciak/tolgyesi-bori.jpeg'} name={'Tölgyesi Bori'} from={'junior researcher, MOME IK'} comment={'Éva rendkívül empatikus és támogató coach, akivel a közös munka során gyorsan és természetesen alakult ki egy hatékony és pozitív légkör. Professzionalizmusa és személyisége nagyban hozzájárult ahhoz, hogy a folyamat eredményes legyen.<br><br>A coaching alkalmak segítettek feloldani az elakadásaimat és új, hasznos megvilágításokat adtak, amelyek előremozdították a szakmai fejlődésemet. Nagyon örülök, hogy együtt dolgozhattunk!'}/>
            </SwiperSlide>
            <SwiperSlide>
