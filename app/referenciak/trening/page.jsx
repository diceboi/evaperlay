  ...
  return (
    ...
    <div className="flex flex-col gap-16">
        <div className="w-full">
          ...
          >
            <SwiperSlide>
              <Coachingreferencetile image={'/referenciak/pecsi-judit.webp'} name={'Pécsi Judit'} from={'HR Director, Union Biztosító'} comment={'<p>Évával trénerként a rejtett előítéletek tréningen találkoztam. Lenyűgöző a tudása ebben a témában, ennél talán a téma iránti elkötelezettsége nagyobb. Megragadott az is, ahogy figyelt ránk, hogy mit fogadtunk be, mi foglalkoztat bennünket a hallottakból. Nem csak az ismereteinket bővítette, de motivált, elgondolkodtatott és finoman arra sarkallt, hogy megkérdőjelezzek egy-két dolgot a meglévő gyakorlatunkban.<br>Sok hét eltelte után is szembejön olyan aspektus, kérdés, amiről ő jut eszembe. Értékelem, hogy behozott olyan szempontokat, amelyekkel tudok jobb vagy még jobb döntéseket hozni.</p>'}/>
            </SwiperSlide>
            <SwiperSlide>
